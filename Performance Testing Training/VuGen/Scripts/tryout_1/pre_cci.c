# 1 "c:\\users\\kshitiz.manral\\documents\\vugen\\scripts\\tryout_1\\\\combined_tryout_1.c"
...
# 1 "c:\\users\\kshitiz.manral\\documents\\vugen\\scripts\\tryout_1\\\\combined_tryout_1.c" 2
...
# 2 "c:\\users\\kshitiz.manral\\documents\\vugen\\scripts\\tryout_1\\\\combined_tryout_1.c" 2
...
# 3 "c:\\users\\kshitiz.manral\\documents\\vugen\\scripts\\tryout_1\\\\combined_tryout_1.c" 2
...
# 4 "c:\\users\\kshitiz.manral\\documents\\vugen\\scripts\\tryout_1\\\\combined_tryout_1.c" 2
	...
	GET()
{
		...
		if (atoi(lr_eval_string("{Id}")) == 2){
			lr_end_transaction("API_101_GET",0);
			lr_vuser_status_message("GET request is PASSED");
		}else{
			lr_end_transaction("API_101_GET",1);
			lr_error_message("FAULED");
		}
		 
	return 0;
}
# 5 "c:\\users\\kshitiz.manral\\documents\\vugen\\scripts\\tryout_1\\\\combined_tryout_1.c" 2
...
# 6 "c:\\users\\kshitiz.manral\\documents\\vugen\\scripts\\tryout_1\\\\combined_tryout_1.c" 2
...
# 7 "c:\\users\\kshitiz.manral\\documents\\vugen\\scripts\\tryout_1\\\\combined_tryout_1.c" 2
