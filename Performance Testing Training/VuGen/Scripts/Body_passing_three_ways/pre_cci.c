# 1 "c:\\users\\kshitiz.manral\\documents\\vugen\\scripts\\body_passing_three_ways\\\\combined_Body_passing_three_ways.c"
...
# 1 "c:\\users\\kshitiz.manral\\documents\\vugen\\scripts\\body_passing_three_ways\\\\combined_Body_passing_three_ways.c" 2
...
# 2 "c:\\users\\kshitiz.manral\\documents\\vugen\\scripts\\body_passing_three_ways\\\\combined_Body_passing_three_ways.c" 2
...
# 3 "c:\\users\\kshitiz.manral\\documents\\vugen\\scripts\\body_passing_three_ways\\\\combined_Body_passing_three_ways.c" 2
...
# 4 "c:\\users\\kshitiz.manral\\documents\\vugen\\scripts\\body_passing_three_ways\\\\combined_Body_passing_three_ways.c" 2

# 1 "CSV_file_upload.c" 1
CSV_file_upload()
{
    ...
    if(strcmp(lr_eval_string("{RespName}"), lr_eval_string("{name}")) == 0){
        lr_end_transaction("API_101_POST", 0);
        lr_vuser_status_message("PASSED for user: %s", lr_eval_string("{name}"));
    } else {
        lr_end_transaction("API_101_POST", 1);
        lr_vuser_status_message("FAILED for user: %s", lr_eval_string("{name}"));
    }

    return 0;
}
# 5 "c:\\users\\kshitiz.manral\\documents\\vugen\\scripts\\body_passing_three_ways\\\\combined_Body_passing_three_ways.c" 2

# 1 "Diff_file_20_times.c" 1
Diff_file_20_times()
{
	web_set_sockets_option("SSL_VERSION","TLS1.2");
    ...
    for (i=1; i<=20; i++)
    {
        ...
        lr_end_transaction(lr_eval_string("Upload_{FileParam}"), 2);
    }
	return 0;
}

# 6 "c:\\users\\kshitiz.manral\\documents\\vugen\\scripts\\body_passing_three_ways\\\\combined_Body_passing_three_ways.c" 2
...
# 7 "c:\\users\\kshitiz.manral\\documents\\vugen\\scripts\\body_passing_three_ways\\\\combined_Body_passing_three_ways.c" 2
...
# 8 "c:\\users\\kshitiz.manral\\documents\\vugen\\scripts\\body_passing_three_ways\\\\combined_Body_passing_three_ways.c" 2
